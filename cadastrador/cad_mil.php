...
<body>
	...
	<div id="container" align="center">
		<div class="alert alert-secondary" role="alert">
			<h4>
				<center>CADASTRO DE MILITARES</center>
				<h4>
					<h5>
						<center>Favor preencher o máximo de campos.</center>
						<h5>
		</div>
		<div class="w-50 p-3">
			<form method="POST" enctype="multipart/form-data" action="insere_mil.php">
				<div class="form-group">
					<center>
						<table class="table table-striped">
							<tr>
								<th>POSTO/GRAD</th>
								<td>
									<div align="left"><select name="MIL_POSTGRAD">
							...
							<tr>
								...
								<td>
									<div><input size="60" type="text" name="MIL_NDG" class="form-control" style="text-transform: uppercase;" /></div>
								</td>
							</tr>
							<tr>
								<th>NOME COMPLETO: </th>
								<td>
									<div><input size="60" type="text" name="MIL_NOME" class="form-control" style="text-transform: uppercase;" /></div>
								</td>
							</tr>
							<tr>
								<th>IDENTIDADE: </th>
								<td>
									<div><input size="60" type="text" name="MIL_IDT" class="form-control" /></div>
								</td>
							</tr>
							...
							<tr>
								<th>SU: </th>
								<td>
									<div align="left"><select name="MIL_BATERIA">
					...
					<tr>
						<th>SEÇÃO: </th>
						<td>
							<div><input size="60" type="text" name="MIL_SECAO" class="form-control" style="text-transform: uppercase;" /></div>
						</td>
					</tr>
					...
					<tr>
						<th>FUNÇÃO: </th>
						<td>
							<div><input size="60" type="text" name="MIL_FUNC" class="form-control" style="text-transform: uppercase;" /></div>
						</td>
					</tr>
					<tr>
	...
	<div class="alert alert-secondary">
		<strong>
			<center>Seção de Informática do 6° Esqd C  Mec
		</strong><br>informatica@6esqdcmec.eb.mil.br</center>
	</div>
