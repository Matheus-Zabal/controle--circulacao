...
<h4><center>CADASTRO DE PERMISSIONÁRIOS E PESSOAL EM OBRAS</center><h4>
...
<table class="table table-striped">
	 ...
	 <th scope="row">NOME COMPLETO: </th>
	   <td><div ><input size="60"  type="text" name="PERM_NOME" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
				<tr>
	 ...
	 <th scope="row">LOCAL DE TRABALHO: </th>
	   <td><div ><input size="60"  type="text" name="PERM_LOCAL" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
	...
	<center><button type ="submit" name="enviar" class="btn btn-primary btn-lg">FINALIZAR CADASTRO</button></center>
		</form>
</div>
</div>
