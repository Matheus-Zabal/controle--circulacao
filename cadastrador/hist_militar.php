...
<div class="alert alert-secondary" role="alert">
     ...
     até <input type="date" name="data1" id="datepicker1" placeholder="Data Final dd/mm/aaaa" value=""/>
	  ...
	  <input type="submit" value="FILTRAR HITÓRICO" name="" class="btn btn-primary btn-lg">
      </form> </center>
      </div>
<center>
...
<table class="table table-striped">
  <tr>
    <th colspan="3" scope="col">DADOS DO MILITAR</th>
  </tr>
  <tr><?php
...
<?php
	//inicia a consulta dos militares cadastrados
	$consulta = $mysqli->query("SELECT * FROM circulacao_pessoas WHERE CIR_MIL_CODIGO=$id ORDER BY `CIR_ENT` desc LIMIT 50" );
	//faz o loop
	while($row = mysqli_fetch_array($consulta)) {
	...
	echo "</table></center>";
	  echo   "<div>";?>
	<center><input type="button" onClick="cont();" value="IMPRIMIR" class="btn btn-primary btn-lg"></center> 
</div>
</div>
</div>
