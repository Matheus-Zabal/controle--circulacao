...
<center>
<h5>PESQUISE O NOME DO VISITANTE MOTORISTA PARA DEPOIS INSERIR OS DADOS</h5>
</center>
<div class="w-50 p-3">
<form method="POST" action="cad_vei1.php">
<center><input type="text" name="busca" id="cod" size="20" class="form-control"></center><br>
