...
<h4><center>CADASTRO DE VISITANTES CIVIS OU MILITARES DE OUTRA OM</center><h4>
<h5><center>Favor preencher o máximo de campos.</center><h5>
</div>
<div class="w-50 p-3">
...
<center><table class="table table-striped">
	 ...
	 <th scope="row">NOME COMPLETO: </th>
	   <td><div ><input size="60"  type="text" name="VIS_NOME" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
				<tr>
	 ...
	 <th scope="row">EMPRESA: </th>
	   <td><div ><input size="60"  type="text" name="VIS_EMPRESA" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
  	<tr>
	 <th scope="row">ENDEREÇO: </th>
	    <td><div ><input size="60"  type="text" name="VIS_ENDERECO" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
		<tr>
	 <th scope="row">NR: </th>
	 ...
	 <th scope="row">COMPLEMENTO: </th>
	    <td><div ><input size="60"  type="text" name="VIS_COMPLEMENTO" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
		<tr>
	 <th scope="row">BAIRRO: </th>
	    <td><div ><input size="60"  type="text" name="VIS_BAIRRO" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
		<tr>
   ...
   <th scope="row">POSTO/GRAD</th>
	...
	<tr>
	 <th scope="row">NOME DE GUERRA: </th>
	   <td><div ><input size="60"  type="text" name="VIS_NDG" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
		<tr>
	 <th scope="row">OM: </th>
	   <td><div ><input size="60"  type="text" name="VIS_OM" class="form-control" style="text-transform: uppercase;"/></div></td>
	 	</tr>
   	<tr>
