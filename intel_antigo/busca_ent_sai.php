...
switch($pub) { 
 ...
 <div id="print" class="conteudo">
 	<h4><center>ENTRADA E SAÍDA DE CIVIS ENTRE <?php echo "$data" ?> e <?php echo "$data1" ?></center></h4>
...
$consulta = $mysqli->query("SELECT * FROM circulacao_pessoas WHERE (CIR_SAIDA BETWEEN '$data_inicial' AND '$data_final') AND CIR_VIS_CODIGO>=0 ORDER BY `CIR_ENT` ASC" );
	...
	echo "<td><a href=".$nome." target=_blank><center>" 	. $row1['VIS_NOME'] . "</a></center></td>";
...
case 'mil': 
	      ?>
		   <div id="print" class="conteudo">
		   	<h4><center>ENTRADA E SAÍDA DE MILITARES ENTRE <?php echo "$data" ?> e <?php echo "$data1" ?></center></h4>
...
$consulta = $mysqli->query("SELECT * FROM circulacao_pessoas WHERE (CIR_SAIDA BETWEEN '$data_inicial' AND '$data_final') AND CIR_MIL_CODIGO>=0 ORDER BY `CIR_ENT` ASC" );
	...
	case 'perm': 
       ?>
		   <div id="print" class="conteudo">
		   	<h4><center>ENTRADA E SAÍDA DE PERMISSIONÁRIOS ENTRE <?php echo "$data" ?> e <?php echo "$data1" ?></center></h4>
   <center><table border=1 width=95%>
     <tr>
	<!-- <th bgcolor="#CCCCCC" width=7%><center>FOTO</center></th> -->
	...
	<center><input type="button" onClick="cont();" value="IMPRIMIR"></center> 
     <?php
        ...
        break; 
			...
			case 'vei': 
       ?>
       <h4><center>ENTRADA E SAÍDA DE VEÍCULOS ENTRE <?php echo "$data" ?> e <?php echo "$data1" ?></center></h4>
