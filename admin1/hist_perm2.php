...
<?php
	//inicia a consulta dos militares cadastrados
$consulta = $mysqli->query("SELECT * FROM circulacao_pessoas WHERE (CIR_SAIDA BETWEEN '$data_inicial' AND '$data_final') AND CIR_PERM_CODIGO=$id ORDER BY `CIR_ENT` desc LIMIT 50" );
	//faz o loop
	while($row = mysqli_fetch_array($consulta)) {
