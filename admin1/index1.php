...
if ($row1) {
    ...
    // Caso o militar não esteja cadastrado, pode exibir algo ou simplesmente ignorar:
    echo "<tr><td colspan='6'><center>Militar com código $codigo não encontrado.</center></td></tr>";
}
	}
?>
<br>
