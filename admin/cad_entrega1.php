...
<h3><center>CADASTRO DE ENTREGAS NO AUQUARTELAMENTO</center><h3>
<h4><center>Favor preencher o máximo de campos.</center><h4>
</div>
 <div class="w-50 p-3">
 <form method="POST" enctype="multipart/form-data" action="inserir_entrega.php">
...
<center>
	...
	<tr>
	 ...
	 <th>NOME COMPLETO (ENTREGADOR): </th>
	   <td><div ><input size="60"  type="text" name="ENT_ENTREGADOR" class="form-control" /></div></td>
	 	</tr>
	 		<tr>
	 <th>EMPRESA: </th>
	   <td><div ><input size="60"  type="text" name="ENT_EMPRE" class="form-control" /></div></td>
	 	</tr>
	 	<tr>
	 <th>NOME COMPLETO (MILITAR QUE RECEBEU): </th>
	   <td><div ><input size="60"  type="text" name="MIL_RECEBEDOR" class="form-control" /></div></td>
	 	</tr>
	 		<tr>
	 <th>DESCRIÇÃO: </th>
	   <td><div ><input size="60"  type="text" name="ENT_DESCRICAO" class="form-control" /></div></td>
	 	</tr>
