...
<input size="60"  type="hidden" name="VEI_FOTO" value="<?php echo $foto ?>"/>
	<tr>
	 ...
	 <th scope="row">DONO NO DOCUMENTO: </th>
	   <td><div ><input size="60"  type="text" class="form-control" name="VEI_DONO" /></div></td>
	 	</tr>
			<tr>
	 ...
	 <th scope="row">MODELO: </th>
	   <td><div ><input size="60"  type="text" class="form-control" name="VEI_MODELO" /></div></td>
	 	</tr
					<tr>
	 ...
	 <th scope="row">MARCA: </th>
	   <td><div ><input size="60"  type="text" class="form-control" name="VEI_MARCA" /></div></td>
	 	</tr>
	 ...
	 <th scope="row">ANO: </th>
	   <td><div ><input size="60"  type="text" class="form-control" name="VEI_ANO" /></div></td>
					...
					<tr>
	 <th scope="row">COR: </th>
	   <td><div ><input size="60"  type="text" class="form-control" name="VEI_COR" /></div></td>
	 	</tr>
	</table>
	</center>
	<center>
