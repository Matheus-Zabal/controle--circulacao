...
$empresa = $_POST['ENT_EMPRE'];

// Insere no banco de dados
$stmt = $mysqli->prepare("INSERT INTO entregas (ENT_ENTREGADOR, ENT_RECEBEDOR, ENT_DESCRICAO, ENT_EMPRE) VALUES (?, ?, ?, ?)");
$stmt->bind_param("ssss", $entregador, $recebedor, $descricao, $empresa);

if ($stmt->execute()) {
    echo "<script>alert('Entrega cadastrada com sucesso!'); window.location.href='cad_entrega.php';</script>";
} else {
