...
<br><br><br><br>
      ...
      <center><strong>DATA INICIAL: </strong> <input type="text" size="50" name="data" id="datepicker" placeholder="dd/mm/aaaa (data menor)" value=""/></center><br>
      <center><strong>DATA FINAL: </strong> <input type="text" size="50" name="data1" id="datepicker1" placeholder="dd/mm/aaaa (data maior)" value=""/></center><br>
