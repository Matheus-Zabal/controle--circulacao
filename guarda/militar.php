...
<table>
	<tr>
		<td><input type="text" name="busca" id="cod" size="20" style="height: 40px; width: 300px;" class="form-control" placeholder="Pesquise por nome de militar"></td>
...
?>
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<p href="busca_mil.php"><input type="button" value=" &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;VOLTAR &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;"></p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
