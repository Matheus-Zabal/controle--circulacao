...
<center><h5>PESQUISE PELO NOME DO VISITANTE</h5></center>
    <form method="POST" action="busca.php">
    <center><input type="text" name="busca" size="20" style="height: 40px; width: 400px;" class="form-control"></center><br>
    <center><input type="submit" value="PESQUISAR" name="" class="btn btn-primary"></center>
    </form>
</div>
<center><h4>PESSOA(S) ENCONTRADA(S) NA PESQUISA</h4></center>
<center>
