...
<h4><center>ALTERAR SENHA</center><h4>
<h5><center>Crie uma senha forte para acesso</center><h5>
</div>
...
<div id="despacho_centro">
        ...
        <div class="form-group">
          <label class="label-control">
            <span class="label-text"> Digite a nova senha:</span>
          </label>
         <input type="password" name="senha" class="form-control" />
        </div>
          <span class="label-text">Confirme a nova senha:</span>
          </label> 
          <input type="password" name="confirmacao" class="form-control" /> <br>
