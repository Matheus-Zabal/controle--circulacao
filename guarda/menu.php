 <ul id="menu-bar">
  ...
  <ul>
  <li><a href="index.php">Visitantes/veículos</a> </li>
  ...
  <li><a href="civis_cad.php">Visitantes</a> </li>
  <li><a href="vei_cad.php">Veículos</a> </li>
  </ul>
  <li><a href="na_om.php">Mil na OM</a> </li>
  <!-- <li><a href="pesquisa.php">Pesquisa entrada saída</a> </li> -->
  <!--<li><a href="#">Cadastrar</a>-->
  <ul>
  <!--  <li><a href="cad_mil.php">Militares</a> </li> -->
  <!-- <li><a href="cad_perm.php">Permissionários</a> </li> -->
  <!--<li><a href="cad_civis.php">Visitantes</a> </li>-->
  <!--<li><a href="cad_vei.php">Veículos</a> </li>-->
  </ul>
